...
import LogoDark from '../../src/images/icon-01.svg';
import Logo from '../../src/images/icon-02.svg';
...
const Login = ({ type }) => {
  ...
  const handleSubmit = async(e) => {
    ...
    if(type==="Company"){
      ...
      const loginCompany = await axios.post(`${BaseUrl}/company/login`, data)
       console.log(loginCompany.data)
       localStorage.removeItem('companyData')
        setUserLogin({ ...userLogin,company:true,employee:false,admin:false, users: loginCompany.data })
       localStorage.setItem('companyData',JSON.stringify({...loginCompany.data,company:true}))
      ...
      console.log(loginEmployee.data);
       ...
       localStorage.setItem('companyData',JSON.stringify({...loginEmployee.data,employee:true}))
       toast.success("login successful!!");
      setTimeout(() => {
        window.location.reload()
      }, 2000);
      ...
      toast.error("Employee login false");
    }
  ...
  return (
    <div>
      ...
      <div className='  p-4  flex justify-center items-center'>
        <div className="rounded-lg w-full md:w-3/4 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form>
                  ...
                  <div className="mb-5">
                    <button
                      ...
                      className="w-full cursor-pointer rounded-lg font-semibold text-lg border border-primary bg-blue-400 p-3 text-white transition hover:bg-opacity-90"
                    > Login</button>
                  </div>
                  ...
                  <div className="mt-6 text-center">
                    <p>
                      ...
                      {
                        type === "Company" ?
                          <NavLink to='/company/signup' className="text-white cursor-pointer font-semibold px-2 py-1 rounded-md bg-blue-600">
                            Sign Up
                          </NavLink>
                          : ''
                      }
